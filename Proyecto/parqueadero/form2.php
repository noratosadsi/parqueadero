...
//consulta si está estacionado
   ...
   $estacionado=consulta($mysql);
    ...
    for ($i = 1; $i <= $m; $i++) 
    {
      ...
      {
        echo "<td align='center' style='width:30px' bgcolor='gray' value='$i'>";
          echo "$i </td>";
      }
      else
      {
...
var q="as";
document.getElementsByName("lugar").value= q;
...
a++;
document.getElementsByName("posicion")[a].disabled= true;
}
var n=0;
while (n < canm) {
...
<?php
    ...
    for ($i = 1; $i <= $b; $i++) 
    {
      ...
      {
        echo "<td style='width:30px' bgcolor='gray' value='$i'>";
          echo "$i</td>";
      }
      else
      {
