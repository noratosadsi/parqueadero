...
<tr align="center">
<td>Nombres</td>
<td>&nbsp;&nbsp;<input type="text" name="nombre" value="<?php echo $con['nombre']; ?>" <?php echo $estilo, $readonly;?> required/>&nbsp;&nbsp;</td>
<td>Marca</td>
...
<td>&nbsp;&nbsp;<select onchange="myFunction()" id="vehiculo" name="tipo" required>
<?php 
